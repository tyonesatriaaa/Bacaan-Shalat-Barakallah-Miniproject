package com.example.bacaanshalatnew.adapter
...
private class NiatShalatAdapter(private val modelBacaan: List<ModelBacaan>) : RecyclerView.Adapter<NiatShalatAdapter.ListViewHolder>() {
