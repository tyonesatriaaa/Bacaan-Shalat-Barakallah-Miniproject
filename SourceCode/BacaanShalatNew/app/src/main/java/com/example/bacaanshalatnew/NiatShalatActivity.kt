package com.example.bacaanshalatnew
...
import com.example.bacaanshalatnew.R
import com.example.bacaanshalatnew.adapter.NiatShalatAdapter
import com.example.bacaanshalatnew.model.ModelBacaan
...
class NiatShalatActivity : AppCompatActivity() {

    var niatShalatAdapter: NiatShalatAdapter? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        niatShalatAdapter = NiatShalatAdapter(modelBacaan)

        rvNiatShalat.setLayoutManager(LinearLayoutManager(this))
        rvNiatShalat.setHasFixedSize(true)
        rvNiatShalat.setAdapter(niatShalatAdapter)
    ...
    private fun getDataNiatShalat() {
        try {
            val stream = assets.open("niatshalat.json")
            ...
            try {
                ...
                niatShalatAdapter?.notifyDataSetChanged()
